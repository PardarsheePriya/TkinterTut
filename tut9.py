...
def getVals():
    ...
    print(f"{nameVal.get(), phoneVal.get(), genderVal.get(), payVal.get(), foodSericeVal.get()}")

    with open("records.txt", "a") as f:
        f.write(f"{nameVal.get(), phoneVal.get(), genderVal.get(), payVal.get(), foodSericeVal.get()}\n")
